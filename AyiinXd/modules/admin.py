...
CMD_HELP.update(
    {
        ...
        \n    └⋟ Bᴜᴀᴛ Jᴀᴅɪɪɴ ᴀᴅᴍɪɴ & ʜᴘs ᴀᴅᴍɪɴ \
        \n\nᴄᴍᴅ: \
        \n    ├⋟ `.ban` & `.uban` <ᴜsᴇʀɴᴀᴍᴇ/ʀᴇᴘʟʏ> \
        \n    └⋟** ʙᴜᴀᴛ ɴɢᴇ ʙᴀɴ & ʙᴜᴋᴀ ʙᴀɴ ᴀɴᴋ ᴅᴀJJᴀʟ \
        \n\nᴄᴍᴅ: \
        \n    ├⋟ `.mute` & `.unmute` <ᴜsᴇʀɴᴀᴍᴇ/ʀᴇᴘʟʏ> \
        \n    └⋟ ʙᴜᴀᴛ ᴅɪᴇᴍɪɴ & ʙᴇʙᴀsɪɴ ᴋᴀɴɢ sᴘᴀᴍ ʏɢ ʙʏᴋ ʙᴄᴅ \
        \n\nᴄᴍᴅ: \
        \n    ├⋟ `.admins` \
        \n    └⋟ ʙᴜᴀᴛ ɴɢɪɴᴛɪᴘ sᴇᴍᴜᴀ ᴀᴅᴍɪɴ ᴅɪ ɢʀᴜʙ \
        \n\nᴄᴍᴅ: \
        \n    ├⋟ `.setgpic` <ᴋᴇʏᴡᴏʀᴅ> \
        \n    ├⋟ ᴋᴇʏᴡᴏʀᴅ : -s ᴘᴀsᴀɴɢ ᴘᴘ ɢᴄ \
        \n    └⋟ ᴋᴇʏᴡᴏʀᴅ : -d ʜᴀᴘᴜs ᴘᴘ ɢᴄ \
        \n\nɴᴏᴛᴇ : \
...
ᴄᴍᴅ:         
  ├⋟ .undelete       
  └⋟ ʙᴜᴀᴛ ʟɪᴀᴛ ᴘᴇsᴀɴ ʏɢ ᴅɪʜᴘs ᴅɪ ɢᴄ            
